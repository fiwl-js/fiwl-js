...
export const bind = async (params:ParamsTemplate):Promise<ResourceInterface> => {
    ...
    const style:FIWLStyle = await ResourceManager.loadStyle(currentStage.resource);
    ...
    return Object.freeze({
        ...
        'loadPicture' : (name:string, extension:string = 'jpg') => {
            return ResourceManager.loadPicture(currentStage.resource, name, extension);
        },
